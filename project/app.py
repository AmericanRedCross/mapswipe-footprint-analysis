...
option = st.selectbox(
    'Select project',
     ('Dar Es Salaam', 'Ushirombo', 'Harare'))
...
def get_connection():
    return sqlalchemy.create_engine('postgresql://alexandertedeschi:postgres@localhost:5432/mapswipe')
...
with st.echo():
    ...
    m = folium.Map(location=[48.73596, 11.18434], zoom_start=9, tiles=tileurl, attr='Mapbox')
